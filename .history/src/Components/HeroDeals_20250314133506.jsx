export default function HeroDeals() {
 ...
 {/* Home and Outdoor section  */}
    ...
    <div className="bg-white rounded-lg shadow-md my-4 p-6 w-full">
 ...
 <div className="bg-white rounded-lg shadow-md p-6 w-full">
      <div className="grid grid-cols-3 gap-6">
        ...
        {/* Items Grid */}
        <div className="col-span-2 grid grid-cols-4 gap-4">
          {items.map((electronicsItems) => (
            <div key={electronicsItems.id} className="border p-4 rounded-md flex flex-col items-center text-center">
              <img src={electronicsItems.image} alt={electronicsItems.name} className="h-20 mb-2" />
              <p className="font-medium">{electronicsItems.name}</p>
              <p className="text-gray-500 text-sm">From {electronicsItems.price}</p>
            </div>
          ))}
        </div>
      </div>
