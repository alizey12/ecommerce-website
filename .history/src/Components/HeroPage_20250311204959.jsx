      ...
      <div className="flex w-full bg-white p-4 shadow-md">
        ...
        <div className="w-3/5 px-4">
          <div className="relative w-full h-[450px] rounded-lg overflow-hidden">
            ...
            />
            {/* Overlay Content */}
            <div className="absolute inset-0 bg-sky-400 bg-opacity-30 flex items-center px-6">
              <div className="text-white">
                <h2 className="text-lg md:text-xl lg:text-2xl font-medium">Latest trending</h2>
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold">Electronic items</h1>
