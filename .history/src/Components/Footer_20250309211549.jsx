  ...
  return (
    <footer className=" text-white">
      <div className="container  mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 bg-gray-400 lg:grid-cols-6 gap-8">
        
        <div className="footer-section">
            <h3 className="text-lg font-bold mb-4">Partnership</h3>
            <ul className="space-y-2">
            <li><img src="src/assets/logo-colored.png" alt="" /></li>
            <h5>Best Information about the company <br/> gies here but now </h5>
