...
import ListingSidebar from "../Components/";
...
const ProductsListing = ({ products = [] }) => {
  ...
  // Reset to first page when filters or view changes
  useEffect(() => {
    setCurrentPage(1);
  }, [filters, view]);
  ...
  const ProductListItem = ({ product }) => (
    <div className="bg-white rounded-lg shadow-sm hover:shadow-md overflow-hidden border border-gray-100 py-4 px-6 sm:px-8 flex flex-col sm:flex-row items-start gap-6 transition-all duration-200">
