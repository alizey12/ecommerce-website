...
export default function HeroDeals() {
    ...
    const regions = [
      { country: "Arabic Emirates", url: "shopname.ae", img: "src/assets/icon.png" },
      { country: "Australia", url: "shopname.ae", flag: "src/assets/AU@2x.png" },
      { country: "United States", url: "shopname.ae", flag: "src/assets/US@2x.png" },
      { country: "Russia", url: "shopname.ru", flag: "" },
      { country: "Denmark", url: "denmark.com.dk", flag: "src/assets/DK@2x.png" },
      { country: "Arabic Emirates", url: "shopname.ae", flag: "src/assets/icon.png" },
      { country: "France", url: "shopname.com.fr", flag: "src/assets/FR@2x.png" },
      { country: "Italy", url: "shopname.it", flag: "src/assets/IT@2x.png" },
      { country: "Great Britain", url: "shopname.co.uk", flag: "src/assets/GB@2x.png" },
      { country: "China", url: "shopname.ae", flag: "src/assets/CN@2x.png" },
    ];
