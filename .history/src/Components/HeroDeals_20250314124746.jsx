export default function HeroDeals() {
    const deals = [
      ...
      { id: 2, name: "Laptops", discount: "-15%", image: "" },
      { id: 3, name: "GoPro cameras", discount: "-40%", image: "" },
      { id: 4, name: "Headphones", discount: "-25%", image: "" },
      { id: 5, name: "Canon cameras", discount: "-25%", image: "" },
    ];
