...
export default function HeroDeals() {
    ...
    const regions = [
      ...
      { country: "Australia", url: "shopname.ae", flag: "🇦🇺" },
      { country: "United States", url: "shopname.ae", flag: "🇺🇸" },
      { country: "Russia", url: "shopname.ru", flag: "🇷🇺" },
      { country: "Denmark", url: "denmark.com.dk", flag: "🇩🇰" },
      { country: "Arabic Emirates", url: "shopname.ae", flag: "" },
