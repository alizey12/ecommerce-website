  ...
  return (
    <header className="w-full shadow-md px-10">
      <div className="flex justify-between items-center p-4 md:px-8">
        ...
        {/* Search bar */}
        <div className="hidden md:flex items-center border rounded-lg overflow-hidden  border-blue-500 border w-1/2">
          <input
            type="text"
            placeholder="Search"
          ...
          <button className="bg-blue-500 border-l outline-none p-3 w-40 text-white ">
            Search
          </button>
        </div>
