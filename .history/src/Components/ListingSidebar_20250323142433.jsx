...
const ListingSidebar = () => {
  ...
  return (
    <aside className="w-1/6 ml-20 p-4 border-r hidden lg:block">
      {/* 📌 Category Section */}
      <div className="mb-6">
        <div className="flex items-center justify-between cursor-pointer" onClick={() => setIsCategoriesOpen(!isCategoriesOpen)}>
      ...
      {/* 📌 Brands Section */}
      <div className="mb-6">
        <div className="flex items-center justify-between cursor-pointer" onClick={() => setIsBrandsOpen(!isBrandsOpen)}>
      ...
      {/* 📌 Features Section */}
      <div className="mb-6">
        <div className="flex items-center justify-between cursor-pointer" onClick={() => setIsFeaturesOpen(!isFeaturesOpen)}>
