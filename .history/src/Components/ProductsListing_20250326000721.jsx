      ...
      View details
          ...
          <div className="flex flex-col  gap-4 w-full">
            {currentProducts.map(({ id, image, name, price, discount, orders, description }) => (
              <div 
                key={id} 
                className="bg-white rounded-lg shadow-sm hover:shadow-md overflow-hidden border border-gray-100 py-4 px-14 flex flex-col sm:flex-row items-start gap-4 transition-all duration-200"
              >
