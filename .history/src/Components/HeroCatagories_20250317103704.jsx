    ...
    return (
      <div className="flex bg-white rounded-sm  my-3  justify-center shadow-md">
        ...
        <div className="w-1/5 px-4 py-6 space-y-4">
          ...
          {/* Offer Boxes */}
          <div className="bg-orange-500 text-white px-6 py-2 rounded-lg text-center hover:bg-orange-600 active:bg-orange-700">
            Get US $10 off with a new supplier
          </div>
          <div className="bg-sky-600 text-white px-6 rounded-lg text-center hover:bg-green-600 active:bg-green-700">
