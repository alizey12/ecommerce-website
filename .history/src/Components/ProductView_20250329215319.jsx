...
const ViewToggle = ({ view, setView, itemCount, products = [], sortType, setSortType, sortedProducts, setSortedProducts }) => {
  useEffect(() => {
    if (sortedProducts.length === 0) {
      setSortedProducts(products);
    }
  }, [products, sortedProducts, setSortedProducts]);
  ...
  }, [sortType, sortedProducts, setSortedProducts]);
