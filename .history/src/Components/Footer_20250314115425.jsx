...
const Footer = () => {
  return (
    <footer className="bg-white px-5  border-t border-gray-300">
      <div className="container">
        ...
        <div className="bg-gray-200 px-10 w-full flex">
          <div className="container  flex flex-wrap justify-between items-center py-4 px-6 text-gray-700 text-sm">
