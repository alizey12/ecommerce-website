...
export default function HeroDeals() {
 ...
 <div className="bg-white shadow-md mb-4 w-full h-full p-4">
  <div className="grid grid-cols-4 gap-0"> {/* Removed gap to minimize space */}
    {/* Left Banner */}
    <div className="relative w-64 h-64 col-span-1">
      ...
      {/* Overlay Content */}
      <div className="absolute top-0 left-0 w-full h-full p-5 flex flex-col justify-start rounded-lg">
    ...
    {/* Items Grid */}
    <div className="col-span-3 grid grid-cols-4 gap-0"> {/* Removed gap to minimize space */}
      {items.map((item) => (
        <div
          key={item.id}
          className="border flex flex-col p-4 justify-between h-32 w-full items-center text-center"
        >
          <div className="text-left w-full"> {/* Ensure text alignment */}
            <p className="font-medium text-sm">{item.name}</p>
            <p className="text-gray-500 text-sm">From {item.price}</p>
          </div>
          <img src={item.image} alt={item.name} className="h-16 object-contain mb-2" />
        </div>
      ))}
    </div>
  </div>
 ...
 <div className="bg-white shadow-md mb-4 w-full h-full ">
  <div className="grid grid-cols-4 ">
    ...
    {/* Items Grid */}
    <div className="grid flex-1 grid-cols-4 col-span-3">
