...
export default function CategorySection() {
    return (
      <div className="flex bg-white rounded-sm  my-3  justify-center shadow-md">
        {/* Left Sidebar */}
        ...
        <div className="w-3/5 px-4">
          <div className="relative w-full h-[450px] overflow-hidden">
            ...
            <img
              ...
              alt="Electronics"
              className="absolute mt-4 mb-6 inset-0 w-full h-full object-cover"
            />
            {/* Overlay Content */}
        ...
        {/* Right Sidebar */}
        <div className="w-1/5 px-4 py-4 space-y-4">
          {/* User Box */}
          <div className="bg--100 p-4 rounded-lg text-center">
            <FaRegCircleUser className="w-12 h-12 bg-whit text-blue-100 rounded-full mx-auto"/>
            <p className="mt-1 text-gray-700">Hi, user</p>
            <p className="text-gray-700">let's get started</p>
            <button className="mt-1 w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 active:bg-blue-700">
              Join now
            </button>
          ...
          {/* Offer Boxes */}
          <div className="bg-orange-500 text-white  py-2 rounded-lg text-center hover:bg-orange-600 active:bg-orange-700">
            Get US $10 off <br/>with a new <br/>supplier
          </div>
          <div className="bg-sky-600 text-white p-2 rounded-lg text-center hover:bg-green-600 active:bg-green-700">
