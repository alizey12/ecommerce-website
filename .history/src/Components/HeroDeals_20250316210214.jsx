...
export default function HeroDeals() {
    ...
    const recomendedProducts = [
      { id: 1, price: "$10.30", name: "T-shirts with multiple colors, for men", image: "/src/assets/blue-shirt." },
      { id: 2, price: "$10.30", name: "Jeans shorts for men blue color", image: "/src/assets/item2.png" },
      { id: 3, price: "$12.50", name: "Brown winter coat medium size", image: "/src/assets/item3.png" },
      { id: 4, price: "$34.00", name: "Jeans bag for travel for men", image: "/src/assets/item4.png" },
      { id: 5, price: "$99.00", name: "Leather wallet", image: "/src/assets/item5.png" },
      { id: 6, price: "$9.99", name: "Canon camera black, 100x zoom", image: "/src/assets/item6.png" },
      { id: 7, price: "$8.99", name: "Headset for gaming with mic", image: "/src/assets/item7.png" },
      { id: 8, price: "$10.30", name: "Smartwatch silver color modern", image: "/src/assets/item8.png" },
      { id: 9, price: "$10.30", name: "Blue wallet for men leather material", image: "/src/assets/item9.png" },
      { id: 10, price: "$80.95", name: "Jeans bag for travel for men", image: "/src/assets/item10.png" },
    ]
    const services = [
      {
        id: 1,
        title: "Source from Industry Hubs",
        image: "/src/assets/service1.png", // Replace with actual image path
...
<div className="relative bg-blue-600 text-white p-10 rounded-lg overflow-hidden">
      {/* Background Image */}
