  ...
  return (
    <header className="w-full shadow-md px-10">
      ...
      <nav className={`md:flex ${isMenuOpen ? 'block' : 'hidden'} px-10 py-4 space-x-4 text-gray-700 items-center` }>
        ...
        <div className="flex items-center space-x-6flex items-center space-x-6 text-gray-600">
          <span className='font-bold'>English, USD</span>
          <FaChevronDown />
        </div>
        <div className="flex items-center space-x-1 text-gray-600">
          <span className='font-bold'>Ship to</span>
          <span className='font-bold' role="img" aria-label="flag"><img src="src/assets/icon.png" alt="" /></span>
          <FaChevronDown />
        </div>
      </nav>
    </header>
