...
export default function HeroDeals() {
 ...
 <div className="bg-white shadow-md mb-4 w-full h-full p-4">
  <div className="grid grid-cols-4 gap-x-4">
    ...
    {/* Items Grid */}
    <div className="grid flex-1 grid-cols-3 gap-4 col-span-3">
      {electronicsItems.map((item) => (
        <div
          key={item.id}
          className="border flex flex-col p-4 justify-between w-full min-w-[100px] h-32 items-center text-center shadow-md rounded-lg"
        >
          <div>
            <p className="font-medium text-sm">{item.name}</p>
            <p className="text-gray-500 text-sm">From {item.price}</p>
