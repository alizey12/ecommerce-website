export default function CategorySection() {
    return (
      <div className="flex bg-white rounded-sm  my-3  justify-center shadow-md">
        ...
        {/* Right Sidebar */}
        <div className="w-1/5 px-4 py-6 space-y-4">
          {/* User Box */}
          ...
          {/* Offer Boxes */}
          <div className="bg-orange-500 text-white px-4 py-2 rounded-lg text-center hover:bg-orange-600 active:bg-orange-700">
            Get US $10 off with a new <br/>supplier
          </div>
          <div className="bg-sky-600 text-white p-4 rounded-lg text-center hover:bg-green-600 active:bg-green-700">
