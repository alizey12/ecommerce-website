...
const Footer = () => {
  return (
    <footer className="bg-slate-500 px-6 border-t border-gray-300">
      <div className="container">
        ...
        <div className="">
  <div className="container bg-gray-200 mx-auto flex flex-wrap justify-between items-center py-4 px-10 text-gray-700 text-sm w-full">
