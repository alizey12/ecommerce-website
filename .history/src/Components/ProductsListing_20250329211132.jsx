...
import ViewToggle from "../Components/ListingSidebar";
...
const SORT_FUNCTIONS = {
  "featured": (a, b) => 0, // Maintain original order
  "low-to-high": (a, b) => parseFloat(a.price) - parseFloat(b.price),
  "high-to-low": (a, b) => parseFloat(b.price) - parseFloat(a.price),
  "a-z": (a, b) => a.name.localeCompare(b.name),
  "z-a": (a, b) => b.name.localeCompare(a.name),
  "new-to-old": (a, b) => new Date(b.date) - new Date(a.date),
  "old-to-new": (a, b) => new Date(a.date) - new Date(b.date),
  "best-selling": (a, b) => b.orders - a.orders,
};
...
const ProductsListing = memo(({ products = [] }) => {
  ...
  // Sort products whenever sortType or products change
  const sortedProducts = useMemo(() => {
    return [...products].sort(SORT_FUNCTIONS[sortType]);
  }, [sortType, products]);
