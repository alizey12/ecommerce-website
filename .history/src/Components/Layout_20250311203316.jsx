export default function CategorySection() {
    return (
      <div className="flex w-full bg-white p-4 shadow-md">
        {/* Left Sidebar */}
        <div className="md:w-1/5 lg:w-1/5 xl:w-1/5 bg-gray-100 p-4 space-y-2 rounded-lg">
          {[
            "Automobiles",
            "Clothes and wear",
            "Home interiors",
        ...
        {/* Banner Section */}
        <div className="md:w-3/5 lg:w-3/5 xl:w-3/5 px-4">
        ...
        {/* Right Sidebar */}
        <div className="md:w-1/5 lg:w-1/5 xl:w-1/5 space-y-4">
          {/* User Box */}
