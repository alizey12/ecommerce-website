...
const ProductsListing = ({ products = [], category = "Mobile Accessories", rating }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6">
      ...
      <span className="text-orange-500 text-sm ml-1">{product.rating}.0</span>
    </div>
 

// Usage in your product component:
<div className="mt-2">
  <StarRating rating={4} />  {/* Manually set to 4 stars */}
</div>
                  </div>
