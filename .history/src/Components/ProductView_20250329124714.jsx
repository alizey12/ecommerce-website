...
const ViewToggle = ({ 
  ...
  const sortProducts = (array, type) => {
    return [...array].sort((a, b) => {
      switch (type) {
        ...
        default:
          return 0; // Keep original order for featured/default
      }
    });
  };
  ...
  useEffect(() => {
    ...
    const sortedArray = sortProducts(filteredProducts, sortType);
    setSortedProducts(sortedArray);
  }, [sortType, products, verifiedOnly, setSortedProducts]);
