...
Features:
Category, Brands, and Features Sections: Each section has its own "See All" functionality.

Reusable Logic: The same logic is applied to all sections for consistency.

Responsive Design: The sidebar is hidden on smaller screens (hidden lg:block).
