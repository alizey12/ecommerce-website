    ...
    <> 
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-8 bg-white p-6 rounded-xl shadow">
          ...
          {/* Main Content Grid */}
          <div className="w-full lg:w-1/2 grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            {/* Supplier Info (1/4 width) */}
            <div className="lg:col-span-1">
              <div className="bg-gray-50 p-4 rounded-lg border h-full">
                <div className="flex items-center mb-3">
                  <FaBox className="text-gray-500 mr-2 text-sm" />
                  <p className="text-gray-500 text-sm">Supplier</p>
                </div>
                <p className="font-medium">{product.supplier?.name || 'Generic Supplier'}</p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm">{product.supplier?.location || 'Worldwide'}</span>
                  </div>
                  
                  {product.supplier?.verified && (
                    <div className="flex items-center">
                      <FaCheckCircle className="mr-2 text-green-600" />
                      <span className="text-green-600 text-sm">Verified Seller</span>
                    </div>
                  )}
                  
                  <div className="flex items-center">
                    <FaGlobeAmericas className="mr-2 text-gray-500" />
                    <span className="text-sm">{product.supplier?.shipping || 'Worldwide shipping'}</span>
                  </div>
                </div>
              ...
              <button className="text-blue-600 py-2 px-4 rounded w-full text-sm flex items-center justify-center mt-2">
