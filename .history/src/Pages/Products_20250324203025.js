...
const productsByCategory = {
    allProducts:[
        { id: 1, name: "Smart watches",price: "USD 19",  discount: "-25%", image: "src/assets/watch.png" },
        { id: 2, name: "Laptops", discount: "-15%", price: "USD 19", image: "src/assets/laptop.png" },
        { id: 3, name: "GoPro cameras",price: "USD 19",  discount: "-40%", image: "src/assets/camera.png" },
        { id: 4, name: "Headphones",price: "USD 19",  discount: "-25%", image: "src/assets/ear-fone.png" },
        { id: 5, name: "Canon cameras",price: "USD 19",  discount: "-25%", image: "src/assets/black-fone.png" },
