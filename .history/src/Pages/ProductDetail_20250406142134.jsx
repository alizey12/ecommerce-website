...
import productsData from "../Pages/Products"; // Updated path
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              ...
              <button 
                className="border border-gray-300 hover:bg-gray-50 py-2 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors"
  ...
  <div className="mt-12">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
      {relatedProducts.map(related => (
        <Link to={`/product/${related.id}`} key={related.id} className="group border rounded-lg p-4 hover:shadow transition">
          ...
          <h3 className="font-medium text-gray-900 group-hover:text-blue-600">{related.name}</h3>
